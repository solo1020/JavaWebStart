...
--
-- Host: localhost    Database: web06_1
-- ------------------------------------------------------
...
INSERT INTO `category` VALUES ('c001','家电'),('c002','服饰'),('c003','化妆品'),('c004',NULL);
...
LOCK TABLES `category_admin` WRITE;
/*!40000 ALTER TABLE `category_admin` DISABLE KEYS */;
INSERT INTO `category_admin` VALUES ('1','手机数码'),('172934bd636d485c98fd2d3d9cccd409','运动户外'),('2','电脑办公'),('3','家具家居'),('4','鞋靴箱包'),('5','图书音像'),('6','母婴孕婴'),('7','汽车用品');
/*!40000 ALTER TABLE `category_admin` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `orderitem` (
  ...
  PRIMARY KEY (`oid`,`pid`),
  KEY `orderitem_product_fk` (`pid`),
  CONSTRAINT `orderitem_orders` FOREIGN KEY (`oid`) REFERENCES `orders` (`oid`),
...
INSERT INTO `product` VALUES ('p001','联想',5000,'c001'),('p002','海尔',5000,'c001'),('p003','雷神',5000,'c001'),('p004','JACK JONES',800,'c002'),('p005','真维斯',200,'c002'),('p006','花花公子',440,'c002'),('p007','劲霸',2000,'c002'),('p008','香奈儿',800,'c003'),('p009','相宜本草',200,'c003'),('p010','海飞丝',0.5,NULL);
/*!40000 ALTER TABLE `product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `product_jsp`
--

DROP TABLE IF EXISTS `product_jsp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `product_jsp` (
...
INSERT INTO `tbl_user` VALUES (1,'老王','666'),(2,'zs','zs'),(3,'张三','999'),(5,'lisi','hehe'),(7,'吕布3','柳岩'),(8,'余淮','xxx');
...
INSERT INTO `user` VALUES (1,'tom','123','tom@it.com'),(2,'lucy','123','lucy@it.com');
...
INSERT INTO `user_tbl` VALUES ('0edfdb47-2f16-448a-9e8c-6ac4075e7e31','qzqqz','qzqz','qzname','qz@12323.com',NULL,'2020-07-29','male',NULL,NULL),('25034894-d6a2-41f2-8303-d5719ea086fa','用户','1234qwer','姓名中文','dsfer@qq.com',NULL,'2020-09-05','female',NULL,NULL),('67e3b5f0-db22-43a4-88be-013920fd7292','用户2','user1234','用户2姓名昵称','user@user.com',NULL,'2020-08-09','male',NULL,NULL);
...
-- Dump completed on 2021-12-30 23:31:27
